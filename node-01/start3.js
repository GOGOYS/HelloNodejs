...
const intKor = []; // Array()
const trees = ["reswood", "bay", "cebar", "oak", "maple"];
...
const student = { 이름: "홍길동", 나이: 33, 전화: "0101010101010" };

console.log("이름" in student);

/*
js에서는 선언된 변수와 null, "", 0, NaN, undefined가 저장된 변수는
"논리적 false로 인식"한다
*/
let title1;
const title2 = null;
...
배열처럼 무자열변수[index]와 같은 코드로 요소의 값을 읽을 수 있다.
